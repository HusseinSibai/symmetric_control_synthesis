...
class AbstractState:
    ...
    def __init__(self, state_id, abstract_targets_centers,
                 abstract_obstacles_centers, concrete_state_indices):
        self.id = state_id # tuple of centers
        self.abstract_targets_centers = abstract_targets_centers
        self.abstract_targets_centers = abstract_targets_centers
